...
contract SecondSwap_MarketplaceSetting is IMarketplaceSetting {
     ...
     */
    IERC20 public usdt; // @audit : make this immuatable
    ...
    constructor(
        ...
        penaltyFee = 10 * 10 ** 6; // @audit-issue : check this in case of usdt/usdc = > 10000000000000 USDT / USDC will be charged in Fee
        referralFee = 1000;
