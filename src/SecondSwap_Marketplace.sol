...
contract SecondSwap_Marketplace is Initializable {
    ...
    function listVesting(
        ...
        require(SecondSwap_Vesting(_vestingPlan).startTime() >= block.timestamp,"SS_Marketplace: vesting is not started yet");
        require(
            doesFunctionExist(
                address(
        ...
        uint256 baseAmount = (_amount * _price) /uint256(10 ** 0);
            //         (
            //             IERC20Extended(
            //                 address(
